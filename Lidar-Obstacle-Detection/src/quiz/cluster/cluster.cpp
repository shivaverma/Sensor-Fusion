...
void createCluster(const std::vector<std::vector<float>>& points, std::vector<int> &cluster, int *flag, KdTree* tree, float distanceTol, int i)
{
    if(flag[i] == 1)
        return;
...
int main ()
{
    ...
    // Searhing nearest points in the tree
